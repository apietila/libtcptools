 ...
 *
 * $Id: tcpsession.h 60 2009-05-13 03:59:37Z salcock $
 *
 */
...
extern const char *tcp_states_text[];	/* = {"SYN_RCVD", "SYN_SENT", "ESTABLISHED", "FIN_WAIT_1", "FIN_WAIT_2", "CLOSING", "TIME_WAIT", "CLOSE_WAIT", "LAST_ACK", "CLOSED"}; */
